 ...
 */
export class CinemaRequestBuilder<
...
> extends RequestBuilder<Cinema<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<Cinema<T>, T> {
    return new GetAllRequestBuilder<Cinema<T>, T>(this.entityApi);
  }
  ...
  create(entity: Cinema<T>): CreateRequestBuilder<Cinema<T>, T> {
    return new CreateRequestBuilder<Cinema<T>, T>(this.entityApi, entity);
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<Cinema<T>, T>(this.entityApi, {
      CinID: cinId
    });
  }
  ...
  update(entity: Cinema<T>): UpdateRequestBuilder<Cinema<T>, T> {
    return new UpdateRequestBuilder<Cinema<T>, T>(this.entityApi, entity);
  }
  ...
  delete(cinIdOrEntity: any): DeleteRequestBuilder<Cinema<T>, T> {
    return new DeleteRequestBuilder<Cinema<T>, T>(
      this.entityApi,
      cinIdOrEntity instanceof Cinema
        ? cinIdOrEntity
        : { CinID: cinIdOrEntity! }
    );
  }
